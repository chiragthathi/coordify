...
export const env = {
  serviceName: process.env.SERVICE_NAME || 'team-service',
  port: Number(process.env.PORT || 4004),
  nodeEnv: process.env.NODE_ENV || 'development',
  mongoUri: process.env.MONGODB_URI || 'mongodb://localhost:27017',
  mongoDbName: process.env.MONGODB_DB_NAME || 'coordify_team_service',
  ...
  rabbitmqTeamNotificationsRoutingKey:
    process.env.RABBITMQ_TEAM_NOTIFICATIONS_ROUTING_KEY ||

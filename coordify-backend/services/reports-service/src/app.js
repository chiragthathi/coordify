...
client.collectDefaultMetrics({ register, prefix: 'coordify_reports_' })

const httpRequestsTotal = new client.Counter({
  name: 'coordify_reports_http_requests_total',
  help: 'Total HTTP requests for reports-service',
  labelNames: ['method', 'route', 'status_code'],
  registers: [register],
})

const httpRequestDurationSeconds = new client.Histogram({
  name: 'coordify_reports_http_request_duration_seconds',
  help: 'HTTP request duration in seconds for reports-service',
  labelNames: ['method', 'route', 'status_code'],

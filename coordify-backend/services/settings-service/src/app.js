...
client.collectDefaultMetrics({ register, prefix: 'coordify_settings_' })

const httpRequestsTotal = new client.Counter({
  name: 'coordify_settings_http_requests_total',
  help: 'Total HTTP requests for settings-service',
  labelNames: ['method', 'route', 'status_code'],
  registers: [register],
})

const httpRequestDurationSeconds = new client.Histogram({
  name: 'coordify_settings_http_request_duration_seconds',
  help: 'HTTP request duration in seconds for settings-service',
  labelNames: ['method', 'route', 'status_code'],

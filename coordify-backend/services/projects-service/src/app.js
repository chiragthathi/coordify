...
client.collectDefaultMetrics({ register, prefix: 'coordify_projects_' })

const httpRequestsTotal = new client.Counter({
  name: 'coordify_projects_http_requests_total',
  help: 'Total HTTP requests for projects-service',
  labelNames: ['method', 'route', 'status_code'],
  registers: [register],
})

const httpRequestDurationSeconds = new client.Histogram({
  name: 'coordify_projects_http_request_duration_seconds',
  help: 'HTTP request duration in seconds for projects-service',
  labelNames: ['method', 'route', 'status_code'],

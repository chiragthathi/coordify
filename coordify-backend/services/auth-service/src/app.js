...
client.collectDefaultMetrics({ register, prefix: 'coordify_auth_' })

const httpRequestsTotal = new client.Counter({
  name: 'coordify_auth_http_requests_total',
  help: 'Total HTTP requests for auth-service',
  labelNames: ['method', 'route', 'status_code'],
  registers: [register],
})

const httpRequestDurationSeconds = new client.Histogram({
  name: 'coordify_auth_http_request_duration_seconds',

...
export const env = {
  ...
  mongoDbName: process.env.MONGODB_DB_NAME || 'coordify_auth_service',
  ...
  redisTokenStoreEnabled: process.env.REDIS_TOKEN_STORE_ENABLED === 'true',
  redisUrl: process.env.REDIS_URL || 'redis://localhost:6379',
  redisTokenPrefix: process.env.REDIS_TOKEN_PREFIX || 'coordify:auth:',
  ...
  rabbitmqAuthNotificationsRoutingKey:
    process.env.RABBITMQ_AUTH_NOTIFICATIONS_ROUTING_KEY ||

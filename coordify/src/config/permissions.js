...
export const ROLE_PERMISSIONS = {
  ...
  [ROLES.MANAGER]: [
    // Managers have admin-equivalent permissions except project deletion
    PERMISSIONS.CREATE_PROJECT,
    PERMISSIONS.EDIT_PROJECT,
    PERMISSIONS.VIEW_PROJECT,
    PERMISSIONS.MANAGE_PROJECT_MEMBERS,
  ...
  [ROLES.MEMBER]: [
    // Members can view projects, edit existing tasks, manage subtasks, and add comments (cannot create tasks)
    PERMISSIONS.VIEW_PROJECT,
    PERMISSIONS.EDIT_TASK,
    PERMISSIONS.COMPLETE_TASK,
    PERMISSIONS.CREATE_COMMENT,

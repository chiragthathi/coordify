...
export const Signup = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const result = await signup(formData.email, formData.name, formData.password, formData.role)
      if (!result?.success) {
      ...
      setSuccessMessage('Account created. We sent an OTP to your email. Verify to continue.')
      setIsLoading(false)
    } catch (err) {
  ...
  const handleVerifyOtp = async (e) => {
    ...
    setIsLoading(true)
    try {
      await authService.verifyEmail(verificationEmail, otp)
  ...
  const handleResendOtp = async () => {
    ...
    try {
      await authService.resendVerificationOtp(verificationEmail)
        ...
        <div className="w-full max-w-md">
          ...
          <div className="mb-8">
            ...
            <p className="text-gray-600 dark:text-gray-400">
              Join Coordify and start collaborating
            </p>
          </div>
          ...
          {successMessage && (
            <div className="mb-4 p-4 bg-green-100 dark:bg-green-900 border border-green-300 dark:border-green-700 text-green-800 dark:text-green-200 rounded-lg text-sm">
              {successMessage}
            </div>
          )}
            ...
            <form onSubmit={handleVerifyOtp} className="space-y-4 mb-6">
              <div>
                ...
                <input
                  ...
                  readOnly
                  className="w-full px-4 py-2.5 border border-gray-300 dark:border-gray-600 rounded-lg bg-gray-100 dark:bg-gray-800 text-gray-900 dark:text-white"
                />
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-2.5 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition tracking-widest"
                  placeholder="123456"
                />
              </div>
              ...
              <button
                ...
                disabled={isLoading}
                className="w-full border border-blue-600 text-blue-600 dark:text-blue-400 py-2.5 rounded-lg hover:bg-blue-50 dark:hover:bg-blue-900/20 transition font-semibold disabled:opacity-50 disabled:cursor-not-allowed"
              >
                Resend OTP
              </button>
            </form>
